...
const Register = ({ handleFormData }) => {
  ...
  const handleInputChange = (event) => {
    ...
    if (
      name.startsWith("Introductory_CourseDetails.") ||
      name.startsWith("Regular_CourseDetails.")
    ) {
  ...
  const handleSubmit = (e) => {
    ...
    axios
      .post("https://techtinker-1.onrender.com/api/register", requestData)
      .then((response) => {
  ...
  const validateForm = () => {
    ...
    if (!formData.PhoneNumber) {
      ...
      formIsValid = false;
      errors.PhoneNumber =
        "Invalid phone number format. Please use xxx-xxx-xxxx format with numbers only";
    }
    ...
    if (!formData.Address.Zipcode) {
      ...
      errors.Address = {
        ...errors.Address,
        Zipcode: "Postal Code should be in the format of A1A 1A1",
      };
    }
    ...
    if (
      formData.RegistrationType === "introductory" &&
      !formData.Introductory_CourseDetails.courseName
    ) {
      formIsValid = false;
    ...
    if (
      ...
      !formData.Regular_CourseDetails.courseName
    ) {
      formIsValid = false;
      errors.courseName = "Course Name is required";
    }
    ...
    if (
      formData.RegistrationType === "regular" &&
      !formData.Regular_CourseDetails.StartDate
    ) {
      formIsValid = false;
    ...
    if (
      formData.RegistrationType === "introductory" &&
      !formData.Introductory_CourseDetails.SelectedDate
    ) {
      formIsValid = false;
    ...
    if (
      formData.RegistrationType === "regular" &&
      !formData.Regular_CourseDetails.ClassTimings
    ) {
      formIsValid = false;
    ...
    if (
      formData.RegistrationType === "introductory" &&
      !formData.Introductory_CourseDetails.SelectedTime
    ) {
      formIsValid = false;
    ...
    <Grid container justifyContent="center">
      <Grid item xs={12} md={6}>
        <Typography
          ...
          align="center"
          gutterBottom
          style={{ color: "#1C796E", margin: "2rem" }}
        >
          Join TechTinkers: Register Here..!
        </Typography>
        <Paper className="course_registration_form" elevation={3}>
          {registrationSuccess ? (
            <Typography
              variant="body1"
              align="center"
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6}>
                    <FormControl fullWidth margin="normal">
                      ...
                      >
                        <MenuItem value="Friday - 5:00 PM - 6:00 PM">
                          Friday - 5:00 PM - 6:00 PM
                        </MenuItem>
                        <MenuItem value="Friday - 6:00 PM - 7:00 PM">
                          Friday - 6:00 PM - 7:00 PM
                        </MenuItem>
                        <MenuItem value="Saturday 10:00 AM - 11:00 AM">
                          Saturday 10:00 AM - 11:00 AM
                        </MenuItem>
                        <MenuItem value="Saturday 11:00 AM - 12:00 PM">
                          Saturday 11:00 AM - 12:00 PM
                        </MenuItem>
                        <MenuItem value="Saturday 12:00 PM - 01:00 PM">
                          Saturday 12:00 PM - 01:00 PM
                        </MenuItem>
                        <MenuItem value="Saturday 01:00 PM - 02:00 PM">
                          Saturday 01:00 AM - 02:00 PM
                        </MenuItem>
                      </Select>
                ...
                <Grid container spacing={2}>
                  ...
                  <Grid item xs={6}>
                    <FormControl fullWidth margin="normal">
                      ...
                      >
                        <MenuItem value="Saturday 10:00 AM - 11:00 PM">
                          Saturday 10:00 AM - 11:00 AM
                        </MenuItem>
                        <MenuItem value="Friday 5:00 PM - 6:00 PM">
                          Friday 5:00 PM - 6:00 PM
