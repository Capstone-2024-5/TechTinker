        ...
        >
          <FormControl>
            ...
            <Stack direction={"column"} marginBottom={3} gap={1}>
              <FormLabel sx={{ flex: "1" }}>Course Details</FormLabel>
              <JoditEditor
                ref={editor}
                value={content}
                required
            ...
            <Stack direction={"row"} alignItems={"center"} marginBottom={3}>
              <FormControl fullWidth>
                ...
                >
                  ...
                  <MenuItem value={"9-14"}>9-14 Years</MenuItem>
                </Select>
              </FormControl>
            </Stack>
            ...
            <Stack direction={"row"} alignItems={"center"} marginBottom={3}>
              <FormLabel sx={{ flex: "1" }}>Introductory Fees</FormLabel>
              <TextField
                type="text"
                variant="outlined"
                color="primary"
                    ...
                    <LocalizationProvider dateAdapter={AdapterDayjs}>
                      <DemoContainer components={["TimePicker"]}>
                        <TimePicker
                          ...
                          onChange={(e) => setCourseStartTime(e)}
                        />
                      </DemoContainer>
            ...
            <Stack direction={"row"} alignItems={"center"} marginBottom={3}>
              <FormLabel sx={{ flex: "1" }}>Duration (Weeks)</FormLabel>
              <TextField
                type="number"
                variant="outlined"
                color="primary"
