    ...
    return (
        <div className="container">
            ...
            <Typography variant="h5" align="center"
                ...
                "At TechTinker, we're on a mission to ignite the passion for
                learning in young minds through hands-on robotics education. Our
                journey began with a simple idea: to provide students with the
                tools and knowledge they need to thrive in an ever-evolving
            ...
            <Grid container paddingTop={0} padding={5} spacing={3}>
                ...
                <Grid item xs={12} sm={12} md={6} sx={{ px: 6, pb: 6 }}>
                    ...
                    >
                        ...
                        <p style={{ fontSize: "20px" }}>
                            TechTinker was founded by a group of passionate
                            educators and technology enthusiasts who saw the
                            need for a creative and engaging approach to STEM
                            education. Drawing from our diverse backgrounds in
                            engineering, education, and innovation, we set out
                            to create an environment where students could
                ...
                <Grid item xs={12} sm={12} md={6} sx={{ px: 6, pb: 6 }}>
                    ...
                    >
                        ...
                        <p style={{ fontSize: "20px" }}>
                            The idea for TechTinker was born out of a desire to
                            bridge the gap between traditional classroom
                            learning and real-world application. We realized
                            that while students were learning valuable concepts
                            in school, they often lacked the opportunity to
                            apply these concepts in a hands-on, practical
                            setting. This gap inspired us to create a program
                            that not only teaches STEM principles but also
                            empowers students to apply these principles to solve
                            real-world problems.
                        </p>
                    </Box>
                </Grid>
                ...
                <Grid item xs={12} sm={12} md={6} sx={{ px: 6, pb: 6 }}>
                    ...
                    >
                        ...
                        <p style={{ fontSize: "20px" }}>
                            From our humble beginnings in a small classroom,
                            we've grown into a thriving community of young
                            innovators and future leaders. Over the years, we've
                            had the privilege of witnessing countless "aha"
                            moments as students tackle challenges, overcome
                            obstacles, and bring their ideas to life. Whether
                            it's building a robot that can navigate a maze or
                            designing a prototype for a sustainable energy
                            solution, each project is a testament to the
                            creativity and ingenuity of our students.
                        </p>
                    </Box>
                </Grid>
                <Grid item xs={12} sm={12} md={6} sx={{ px: 6, pb: 6 }}>
                ...
                <Grid item xs={12} sm={12} md={6} sx={{ px: 6, pb: 6 }}>
                    ...
                    >
                        ...
                        <p style={{ fontSize: "20px" }}>
                            At TechTinker, our mission is simple: to inspire the
                            next generation of engineers, innovators, and
                            problem solvers. We believe that by providing
                            students with the skills and confidence they need to
                            succeed in STEM fields, we're not just shaping
                            future engineers – we're shaping the future of
                            innovation itself.
                        </p>
                    </Box>
                </Grid>
                ...
                <Grid item xs={12} sm={12} md={6} sx={{ px: 6, pb: 6 }}>
                    ...
                    >
                        ...
                        <p style={{ fontSize: "20px" }}>
                            ...
                            exploration and discovery. Whether you're a student
                            looking to explore the exciting world of robotics or
                            an educator seeking new ways to engage your
                            students, there's a place for you at TechTinker.
                            Together, let's ignite the spark of curiosity,
